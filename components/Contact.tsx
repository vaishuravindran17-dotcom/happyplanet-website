            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    href="https://www.google.com/travel/search?ts=CAEaKwopEicyJTB4M2E1NTIxYzNlZmNmZmJiZDoweDE2ODc2MWY4NmU4ZjMyOTg&qs=CAEyE0Nnb0ltT1c4OUlhXzJNTVdFQUU4Ag&utm_campaign=sharing&utm_medium=link_btn&utm_source=htls"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#2c2416] hover:text-[#3d5a3e] transition-colors flex items-center gap-1 group"
                    style={{ fontFamily: "'Cormorant Garamond', serif" }}
                  >
                    Near Mayiladuthurai, Tamil Nadu
                    <svg className="w-3.5 h-3.5 opacity-50 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-xs text-[#8b6914] hover:underline mt-1 inline-block"
                    style={{ fontFamily: "'Inter', sans-serif" }}
                  >
                    View on Google Maps →
                  </a>
              ...
              <div className="flex flex-col gap-3">
                {AIRBNB_LINKS.map((link) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-3 border border-[#e8e0d5] px-5 py-3 hover:border-[#ff5a5f] transition-colors group"
                  >
